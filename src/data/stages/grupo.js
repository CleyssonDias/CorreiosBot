...
async function execute(client, user, msg, contato) {
  ...
  await client.sendText(userr.grup.id, `*🤔INFORMAÇÕES DO ATENDIMENTO🤔*
...
*😉 Um(a) de nossos atendentes ira cuidar no seu caso em ate 24hrs aguarde!😉*`)
  await client.sendText('120363044322820074@g.us', `🎫 NOVO ATENDIMENTO ABERTO 🎫
😴Nome do cliente: ${contato}
😁Motivo do atendimento: ${userr.proble}
💽Id: ${userr.grup.id} `)
